        ...
        <section className="max-w-2xl">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-3">
            <div className="rounded-[1.5rem] border border-white/10 bg-white/[0.05] p-5">
              ...
              <p className="mt-3 text-lg font-semibold text-white">Create account</p>
            </div>
            <div className="rounded-[1.5rem] border border-white/10 bg-white/[0.05] p-5">
              <p className="text-sm uppercase tracking-[0.25em] text-stone-400">
                Step 02
              </p>
              <p className="mt-3 text-lg font-semibold text-white">Set up profile</p>
            </div>
            <div className="rounded-[1.5rem] border border-white/10 bg-white/[0.05] p-5">
              <p className="text-sm uppercase tracking-[0.25em] text-stone-400">
                Step 03
              </p>
              <p className="mt-3 text-lg font-semibold text-white">Open dashboard</p>
            </div>
          </div>
        </section>
        <AuthCard />
