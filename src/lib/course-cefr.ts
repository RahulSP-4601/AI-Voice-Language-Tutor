...
function createCefrSeed(
  ...
  return {
    ...
    guidedPrompt,
    checkpoint,
    demoPhrase: renderText(demoPhrase, languageName, phrase),
    replyPrompt: renderText(replyPrompt, languageName, phrase),
    acceptableResponses: [renderText(acceptableResponses, languageName, phrase)],
  };
}
